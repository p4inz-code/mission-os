//! D-Bus signal helper types for mission-securityd.
//!
...
//! ## Signals
//!
//! The actual signal emission is handled by [`crate::dbus::emit_security_event`]
//! and [`crate::dbus::emit_health_changed`], which use these helpers.
